...
firstLi.addEventListener('click', adicionar);
secondLi.addEventListener('click', adicionar);
thirdLi.addEventListener('click', adicionar);
...
function webpage() {
  window.location.replace('https://github.com/phsantoro');
}
...
myWebpage.addEventListener('mouseover', mouse);
